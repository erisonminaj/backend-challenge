...
SECRET_KEY = 'django-insecure-^u#2(o8#*3e1l$bbkf0lmc*9xhphr+f^ojsfk4l^3zpxx&i=q$'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        ...
        'rest_framework.renderers.BrowsableAPIRenderer', # Use only the JSON renderer
    ),
...
# Redirect users to the API root after login
